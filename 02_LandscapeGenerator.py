"""
    ...
    Referenced in this script:
        ...
        Image used to generate landscape in final scene accidentally sourced from a screenshot from an episode of 90s Japanese game show マジカル頭脳パワー (majgical brain power) :
                日本テレビ, 1997. マジカル頭脳パワー Available at: https://www.bilibili.com/video/BV1Ga411w7Xs/?p=10&spm_id_from=pageDriver [Accessed 12 2021]
"""
